...
@section('content')
        ...
        <div class="col-md-4 col-md-offset-4 sign-up">
            <h2>Sign Up&nbsp;<span class="glyphicon glyphicon-log-in"></span></h2>
            <form action="{!! URL::to('user/signup','',false) !!}" method="post">
                ...
                <div class="form-group">
                    <button type="submit" name="submit" class="btn btn-block signup" id="block"><span class="glyphicon glyphicon-log-in"></span>&nbsp; Sign Up</button>
                </div>
                {!! Form::token() !!}
            </form>
        </div>
